...
{
    "distutils": {
        "name": "fast_distance_computation",
        "sources": [
            "/scratch/users/strobelm@umd.edu/scPDB/fast_distance_computation.pyx"
        ]
    },
    "module_name": "fast_distance_computation"
}
END: Cython Metadata */
...
#define __PYX_HAVE__fast_distance_computation
#define __PYX_HAVE_API__fast_distance_computation
/* Early includes */
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
...
/* Module declarations from 'fast_distance_computation' */
...
#define __Pyx_MODULE_NAME "fast_distance_computation"
extern int __pyx_module_is_main_fast_distance_computation;
int __pyx_module_is_main_fast_distance_computation = 0;

/* Implementation of 'fast_distance_computation' */
...
static const char __pyx_k_coord_view[] = "coord_view";
...
static const char __pyx_k_sparse_contacts[] = "sparse_contacts";
...
static const char __pyx_k_fast_distance_computation[] = "fast_distance_computation";
static const char __pyx_k_itemsize_0_for_cython_array[] = "itemsize <= 0 for cython.array";
static const char __pyx_k_fast_distance_computation_pyx[] = "fast_distance_computation.pyx";
...
static PyObject *__pyx_n_s_coord_view;
...
static PyObject *__pyx_n_s_fast_distance_computation;
static PyObject *__pyx_kp_s_fast_distance_computation_pyx;
...
static PyObject *__pyx_n_s_sparse_contacts;
...
static PyObject *__pyx_pf_25fast_distance_computation_get_distance_matrix(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_coord, PyObject *__pyx_v_sparse_contacts, PyObject *__pyx_v_cutoff); /* proto */
...
/* "fast_distance_computation.pyx":23
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_25fast_distance_computation_1get_distance_matrix(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_25fast_distance_computation_1get_distance_matrix = {"get_distance_matrix", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_25fast_distance_computation_1get_distance_matrix, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_25fast_distance_computation_1get_distance_matrix(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyObject *__pyx_v_coord = 0;
  PyObject *__pyx_v_sparse_contacts = 0;
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_coord,&__pyx_n_s_sparse_contacts,&__pyx_n_s_cutoff,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_sparse_contacts)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("get_distance_matrix", 1, 3, 3, 1); __PYX_ERR(0, 23, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_cutoff)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("get_distance_matrix", 1, 3, 3, 2); __PYX_ERR(0, 23, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "get_distance_matrix") < 0)) __PYX_ERR(0, 23, __pyx_L3_error)
      }
    ...
    __pyx_v_sparse_contacts = values[1];
    __pyx_v_cutoff = values[2];
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("get_distance_matrix", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 23, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("fast_distance_computation.get_distance_matrix", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_25fast_distance_computation_get_distance_matrix(__pyx_self, __pyx_v_coord, __pyx_v_sparse_contacts, __pyx_v_cutoff);
...
static PyObject *__pyx_pf_25fast_distance_computation_get_distance_matrix(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_coord, PyObject *__pyx_v_sparse_contacts, PyObject *__pyx_v_cutoff) {
  int __pyx_v_rows;
  __Pyx_memviewslice __pyx_v_coord_view = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_i;
  int __pyx_v_j;
  double __pyx_v_rr[3];
  double __pyx_v_dist;
  ...
  /* "fast_distance_computation.pyx":24
 * @cython.boundscheck(False)
 * def get_distance_matrix(coord, sparse_contacts, cutoff):
 *     cdef int rows = len(coord)             # <<<<<<<<<<<<<<
 *     cdef float[:, ::1] coord_view = coord
 * 
 */
  __pyx_t_1 = PyObject_Length(__pyx_v_coord); if (unlikely(__pyx_t_1 == ((Py_ssize_t)-1))) __PYX_ERR(0, 24, __pyx_L1_error)
  __pyx_v_rows = __pyx_t_1;

  /* "fast_distance_computation.pyx":25
 * def get_distance_matrix(coord, sparse_contacts, cutoff):
 *     cdef int rows = len(coord)
 *     cdef float[:, ::1] coord_view = coord             # <<<<<<<<<<<<<<
 * 
 *     cdef int i, j
 */
  __pyx_t_2 = __Pyx_PyObject_to_MemoryviewSlice_d_dc_float(__pyx_v_coord, PyBUF_WRITABLE); if (unlikely(!__pyx_t_2.memview)) __PYX_ERR(0, 25, __pyx_L1_error)
  __pyx_v_coord_view = __pyx_t_2;
  __pyx_t_2.memview = NULL;
  __pyx_t_2.data = NULL;

  /* "fast_distance_computation.pyx":30
 *     cdef double[3] rr
 *     cdef double dist
 *     for i in range(rows):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_5 = 0; __pyx_t_5 < __pyx_t_4; __pyx_t_5+=1) {
    ...
    /* "fast_distance_computation.pyx":31
 *     cdef double dist
 *     for i in range(rows):
 *         for j in range(i+1, rows):             # <<<<<<<<<<<<<<
 *             rr[0] = coord_view[i, 0] - coord_view[j, 0]
 ...
 */
    ...
    for (__pyx_t_8 = (__pyx_v_i + 1); __pyx_t_8 < __pyx_t_7; __pyx_t_8+=1) {
      ...
      /* "fast_distance_computation.pyx":32
 *     for i in range(rows):
 *         for j in range(i+1, rows):
 *             rr[0] = coord_view[i, 0] - coord_view[j, 0]             # <<<<<<<<<<<<<<
 *             rr[1] = coord_view[i, 1] - coord_view[j, 1]
 ...
 */
      __pyx_t_9 = __pyx_v_i;
      __pyx_t_10 = 0;
      if (__pyx_t_9 < 0) __pyx_t_9 += __pyx_v_coord_view.shape[0];
      if (__pyx_t_10 < 0) __pyx_t_10 += __pyx_v_coord_view.shape[1];
      __pyx_t_11 = __pyx_v_j;
      __pyx_t_12 = 0;
      if (__pyx_t_11 < 0) __pyx_t_11 += __pyx_v_coord_view.shape[0];
      if (__pyx_t_12 < 0) __pyx_t_12 += __pyx_v_coord_view.shape[1];
      (__pyx_v_rr[0]) = ((*((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_coord_view.data + __pyx_t_9 * __pyx_v_coord_view.strides[0]) )) + __pyx_t_10)) ))) - (*((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_coord_view.data + __pyx_t_11 * __pyx_v_coord_view.strides[0]) )) + __pyx_t_12)) ))));

      /* "fast_distance_computation.pyx":33
 *         for j in range(i+1, rows):
 *             rr[0] = coord_view[i, 0] - coord_view[j, 0]
 *             rr[1] = coord_view[i, 1] - coord_view[j, 1]             # <<<<<<<<<<<<<<
 *             rr[2] = coord_view[i, 2] - coord_view[j, 2]
 ...
 */
      ...
      __pyx_t_11 = 1;
      if (__pyx_t_12 < 0) __pyx_t_12 += __pyx_v_coord_view.shape[0];
      if (__pyx_t_11 < 0) __pyx_t_11 += __pyx_v_coord_view.shape[1];
      __pyx_t_10 = __pyx_v_j;
      __pyx_t_9 = 1;
      if (__pyx_t_10 < 0) __pyx_t_10 += __pyx_v_coord_view.shape[0];
      if (__pyx_t_9 < 0) __pyx_t_9 += __pyx_v_coord_view.shape[1];
      (__pyx_v_rr[1]) = ((*((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_coord_view.data + __pyx_t_12 * __pyx_v_coord_view.strides[0]) )) + __pyx_t_11)) ))) - (*((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_coord_view.data + __pyx_t_10 * __pyx_v_coord_view.strides[0]) )) + __pyx_t_9)) ))));

      /* "fast_distance_computation.pyx":34
 *             rr[0] = coord_view[i, 0] - coord_view[j, 0]
 *             rr[1] = coord_view[i, 1] - coord_view[j, 1]
 *             rr[2] = coord_view[i, 2] - coord_view[j, 2]             # <<<<<<<<<<<<<<
 *             dist = sqrt(rr[0]*rr[0] + rr[1]*rr[1] + rr[2]*rr[2])
 ...
 */
      ...
      if (__pyx_t_11 < 0) __pyx_t_11 += __pyx_v_coord_view.shape[0];
      if (__pyx_t_12 < 0) __pyx_t_12 += __pyx_v_coord_view.shape[1];
      (__pyx_v_rr[2]) = ((*((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_coord_view.data + __pyx_t_9 * __pyx_v_coord_view.strides[0]) )) + __pyx_t_10)) ))) - (*((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_coord_view.data + __pyx_t_11 * __pyx_v_coord_view.strides[0]) )) + __pyx_t_12)) ))));

      /* "fast_distance_computation.pyx":35
 *             rr[1] = coord_view[i, 1] - coord_view[j, 1]
 *             rr[2] = coord_view[i, 2] - coord_view[j, 2]
 *             dist = sqrt(rr[0]*rr[0] + rr[1]*rr[1] + rr[2]*rr[2])             # <<<<<<<<<<<<<<
 *             if dist < cutoff:
 ...
 */
      __Pyx_GetModuleGlobalName(__pyx_t_14, __pyx_n_s_sqrt); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 35, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_14);
      __pyx_t_15 = PyFloat_FromDouble(((((__pyx_v_rr[0]) * (__pyx_v_rr[0])) + ((__pyx_v_rr[1]) * (__pyx_v_rr[1]))) + ((__pyx_v_rr[2]) * (__pyx_v_rr[2])))); if (unlikely(!__pyx_t_15)) __PYX_ERR(0, 35, __pyx_L1_error)
      ...
      if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 35, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_13);
      __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
      __pyx_t_17 = __pyx_PyFloat_AsDouble(__pyx_t_13); if (unlikely((__pyx_t_17 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 35, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
      __pyx_v_dist = __pyx_t_17;

      /* "fast_distance_computation.pyx":36
 *             rr[2] = coord_view[i, 2] - coord_view[j, 2]
 *             dist = sqrt(rr[0]*rr[0] + rr[1]*rr[1] + rr[2]*rr[2])
 *             if dist < cutoff:             # <<<<<<<<<<<<<<
 *                 sparse_contacts[i, j] = dist
 ...
 */
      __pyx_t_13 = PyFloat_FromDouble(__pyx_v_dist); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 36, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_13);
      __pyx_t_14 = PyObject_RichCompare(__pyx_t_13, __pyx_v_cutoff, Py_LT); __Pyx_XGOTREF(__pyx_t_14); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 36, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
      __pyx_t_18 = __Pyx_PyObject_IsTrue(__pyx_t_14); if (unlikely(__pyx_t_18 < 0)) __PYX_ERR(0, 36, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
      if (__pyx_t_18) {

        /* "fast_distance_computation.pyx":37
 *             dist = sqrt(rr[0]*rr[0] + rr[1]*rr[1] + rr[2]*rr[2])
 *             if dist < cutoff:
 *                 sparse_contacts[i, j] = dist             # <<<<<<<<<<<<<<
 *                 sparse_contacts[j, i] = dist
 */
        __pyx_t_14 = PyFloat_FromDouble(__pyx_v_dist); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 37, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_14);
        __pyx_t_13 = __Pyx_PyInt_From_int(__pyx_v_i); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 37, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_13);
        __pyx_t_15 = __Pyx_PyInt_From_int(__pyx_v_j); if (unlikely(!__pyx_t_15)) __PYX_ERR(0, 37, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_15);
        ...
        __pyx_t_13 = 0;
        __pyx_t_15 = 0;
        if (unlikely(PyObject_SetItem(__pyx_v_sparse_contacts, __pyx_t_16, __pyx_t_14) < 0)) __PYX_ERR(0, 37, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_16); __pyx_t_16 = 0;
        __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;

        /* "fast_distance_computation.pyx":38
 *             if dist < cutoff:
 *                 sparse_contacts[i, j] = dist
 *                 sparse_contacts[j, i] = dist             # <<<<<<<<<<<<<<
 */
        __pyx_t_14 = PyFloat_FromDouble(__pyx_v_dist); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 38, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_14);
        __pyx_t_16 = __Pyx_PyInt_From_int(__pyx_v_j); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 38, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_16);
        __pyx_t_15 = __Pyx_PyInt_From_int(__pyx_v_i); if (unlikely(!__pyx_t_15)) __PYX_ERR(0, 38, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_15);
        ...
        __pyx_t_16 = 0;
        __pyx_t_15 = 0;
        if (unlikely(PyObject_SetItem(__pyx_v_sparse_contacts, __pyx_t_13, __pyx_t_14) < 0)) __PYX_ERR(0, 38, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
        __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
 ...
 */
  ...
  __pyx_r = NULL;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_coord_view, 1);
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "fast_distance_computation.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "fast_distance_computation.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "fast_distance_computation.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "fast_distance_computation._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec_fast_distance_computation(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_fast_distance_computation},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_coord_view, __pyx_k_coord_view, sizeof(__pyx_k_coord_view), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_fast_distance_computation, __pyx_k_fast_distance_computation, sizeof(__pyx_k_fast_distance_computation), 0, 0, 1, 1},
  {&__pyx_kp_s_fast_distance_computation_pyx, __pyx_k_fast_distance_computation_pyx, sizeof(__pyx_k_fast_distance_computation_pyx), 0, 0, 1, 0},
  ...
  {&__pyx_n_s_sparse_contacts, __pyx_k_sparse_contacts, sizeof(__pyx_k_sparse_contacts), 0, 0, 1, 1},
 ...
 *     cdef float[:, ::1] coord_view = coord
 */
  __pyx_tuple__19 = PyTuple_Pack(9, __pyx_n_s_coord, __pyx_n_s_sparse_contacts, __pyx_n_s_cutoff, __pyx_n_s_rows, __pyx_n_s_coord_view, __pyx_n_s_i, __pyx_n_s_j, __pyx_n_s_rr, __pyx_n_s_dist); if (unlikely(!__pyx_tuple__19)) __PYX_ERR(0, 23, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__19);
  __Pyx_GIVEREF(__pyx_tuple__19);
  __pyx_codeobj__20 = (PyObject*)__Pyx_PyCode_New(3, 0, 9, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__19, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_fast_distance_computation_pyx, __pyx_n_s_get_distance_matrix, 23, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__20)) __PYX_ERR(0, 23, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initfast_distance_computation(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initfast_distance_computation(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_fast_distance_computation(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_fast_distance_computation(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_fast_distance_computation(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'fast_distance_computation' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_fast_distance_computation(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("fast_distance_computation", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_fast_distance_computation) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "fast_distance_computation")) {
      if (unlikely(PyDict_SetItemString(modules, "fast_distance_computation", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "fast_distance_computation.pyx":2
 * import cython
 * import numpy             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "fast_distance_computation.pyx":3
 * import cython
 * import numpy
 * from math import sqrt             # <<<<<<<<<<<<<<
 * 
 ...
 *     cdef float[:, ::1] coord_view = coord
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_25fast_distance_computation_1get_distance_matrix, NULL, __pyx_n_s_fast_distance_computation); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 23, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_get_distance_matrix, __pyx_t_2) < 0) __PYX_ERR(0, 23, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "fast_distance_computation.pyx":1
 * import cython             # <<<<<<<<<<<<<<
 * import numpy
 * from math import sqrt
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init fast_distance_computation", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init fast_distance_computation");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
