...
train_dataloader = DataLoader(train_set, batch_size = 3, shuffle=True, pin_memory=True, num_workers=num_cpus)
val_dataloader = DataLoader(val_set, batch_size = 3, shuffle=True, pin_memory=True, num_workers=num_cpus)
